...
describe('Flags.has() should', () => {
    ...
    it('throw on 0', () => expect(() => instance.has(TestOptions.None)).toThrowError());
...
describe('Flags.hasEvery() should', () => {
    ...
    it('throw on 0', () => expect(() => instance.hasEvery(TestOptions.None, TestOptions.CleanUpAfter)).toThrowError());
...
describe('Flags.set() should', () => {
    ...
    it('throw on 0', () => expect(() => new Flags(flags).set(TestOptions.None)).toThrowError());
...
describe('Flags.unset() should', () => {
    ...
    it('throw on 0', () => expect(() => new Flags(flags).unset(TestOptions.None)).toThrowError());
